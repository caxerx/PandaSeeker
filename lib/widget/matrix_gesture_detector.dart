...
typedef MatrixGestureDetectorEndCallback = void Function(
    Matrix4 matrix,
    Matrix4 translationDeltaMatrix,
    Matrix4 scaleDeltaMatrix,
    Matrix4 rotationDeltaMatrix,
...
typedef MatrixGestureDetectorStartCallback = void Function(
    Matrix4 matrix,
    Matrix4 translationDeltaMatrix,
    Matrix4 scaleDeltaMatrix,
    Matrix4 rotationDeltaMatrix,
...
class MatrixGestureDetector extends StatefulWidget {
  ...
  /// [Matrix4] end notification callback
  ///
...
class MatrixGestureDetectorState extends State<MatrixGestureDetector> {
  ...
  void onScaleEnd(ScaleEndDetails details) {
    widget.onMatrixUpdateEnd(matrix, translationDeltaMatrix, scaleDeltaMatrix,
